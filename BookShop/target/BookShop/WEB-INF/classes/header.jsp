        ...
        <nav class="navbar navbar-default" role="navigation">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <ul class="multi-column-dropdown">
                                            ...
                                            <c:forEach items="${typeList}" var="t">
                                                <li><a class="list" href="#">${t.name}</a></li>
                                            </c:forEach>
                    ...
                    <li><a href="#" <c:if test="${param.flag==3 && t==2}">class="active"</c:if>>热销</a></li>
                    <li><a href="#" <c:if test="${param.flag==3 && t==3}">class="active"</c:if>>新品</a></li>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li><a href="#" <c:if test="${param.flag==5 }">class="active"</c:if>>我的订单</a></li>
                            <li><a href="#" <c:if test="${param.flag==4 }">class="active"</c:if>>个人中心</a></li>
                            <li><a href="#" >退出</a></li>
                    </c:otherwise>
                    </c:choose>
